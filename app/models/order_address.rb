class OrderAddress
  ...
  attr_accessor :user_id, :item_id, :post_code, :prefecture_id, :city, :address, :building_name, :phone_number, :token, :price
  ...
  with_options presence: true do
    ...
    validates :phone_number, length: { maximum: 11 }, format: { with: /\A[0-9]+\z/, message: "Input only number", allow_blank: true }
